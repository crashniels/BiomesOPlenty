...
public class BOPFeatures
{
	...
	public static final BlockClusterFeatureConfig EXTENDED_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder((new WeightedBlockStateProvider()).add(Blocks.OXEYE_DAISY.getDefaultState(), 1).add(Blocks.POPPY.getDefaultState(), 1).add(Blocks.DANDELION.getDefaultState(), 1), SimpleBlockPlacer.INSTANCE)).tries(64).build();
	...
	public static final BlockClusterFeatureConfig MOOR_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder((new WeightedBlockStateProvider()).add(Blocks.ALLIUM.getDefaultState(), 1).add(BOPBlocks.violet.getDefaultState(), 1), SimpleBlockPlacer.INSTANCE)).tries(64).build();
	...
	public static final BlockClusterFeatureConfig ORIGIN_VALLEY_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder((new WeightedBlockStateProvider()).add(BOPBlocks.rose.getDefaultState(), 6).add(Blocks.DANDELION.getDefaultState(), 4), SimpleBlockPlacer.INSTANCE)).tries(64).build();
	...
	public static final BlockClusterFeatureConfig RAINFOREST_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder((new WeightedBlockStateProvider()).add(BOPBlocks.orange_cosmos.getDefaultState(), 1).add(Blocks.POPPY.getDefaultState(), 1).add(Blocks.DANDELION.getDefaultState(), 1), SimpleBlockPlacer.INSTANCE)).tries(64).build();
	public static final BlockClusterFeatureConfig SNOWY_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder((new WeightedBlockStateProvider()).add(BOPBlocks.violet.getDefaultState(), 1).add(Blocks.POPPY.getDefaultState(), 1).add(Blocks.DANDELION.getDefaultState(), 1), SimpleBlockPlacer.INSTANCE)).tries(64).build();
	public static final BlockClusterFeatureConfig TROPICS_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder((new WeightedBlockStateProvider()).add(BOPBlocks.pink_hibiscus.getDefaultState(), 1).add(Blocks.POPPY.getDefaultState(), 1).add(Blocks.DANDELION.getDefaultState(), 1), SimpleBlockPlacer.INSTANCE)).tries(64).build();
	public static final BlockClusterFeatureConfig WETLAND_FLOWER_CONFIG = (new BlockClusterFeatureConfig.Builder((new WeightedBlockStateProvider()).add(Blocks.BLUE_ORCHID.getDefaultState(), 1).add(Blocks.POPPY.getDefaultState(), 1).add(Blocks.DANDELION.getDefaultState(), 1), SimpleBlockPlacer.INSTANCE)).tries(64).build();
